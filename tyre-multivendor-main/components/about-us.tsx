  ...
  return (
    <div className=' min-h-screen bg-linear-to-br  from-[#e5e5e5] via-white to-[#e5e5e5]'>
        ...
        <div className='relative container mx-auto px-4 py-20'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <h1 className='text-5xl md:text-6xl font-bold mb-6'>
             <span className='text-[#fca311]'>Autodeal4U</span>
            </h1>
      ...
      <section className='py-16 -mt-12 relative z-10'>
        <div className='container max-w-4 px-4'>
      ...
      <section className='py-20 bg-linear-to-r from-white to-[#e5e5e5]'>
        <div className='container mx-auto px-4'>
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            ...
            <div className='relative'>
              ...
              <div className='absolute -bottom-6 -right-3 bg-white rounded-2xl p-6 shadow-xl border border-[#e5e5e5]/50'>
      ...
      <section className='py-20 bg-linear-to-br from-[#14213d] via-[#1a2b4a] to-[#14213d] text-white relative overflow-hidden'>
        <div className="absolute inset-0 bg-[url('/images/tyre-pattern.svg')] opacity-5"></div>
            ...
            {values.map((value, index) => (
              <Card
                ...
                className={`group cursor-pointer transition-all duration-500 hover:shadow-2xl rounded-2xl overflow-hidden border-[#e5e5e5]/50 ${
                  activeValue === index ? 'ring-2 ring-[#fca311] shadow-xl' : ''
                }`}
      ...
      <section className='py-20 bg-linear-to-br from-[#e5e5e5] to-white'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            <h2 className='text-4xl font-bold text-[#000000] mb-4'>
        ...
        <div className='container mx-auto px-4'>
          ...
          <div className='grid grid-cols-2 lg:grid-cols-4 gap-8'>
            {certifications.map((cert, index) => (
              ...
              >
                <CardContent className='p-8'>
                  <div className='w-20 h-20 mx-auto mb-4 bg-[#e5e5e5] rounded-2xl flex items-center justify-center group-hover:bg-[#fca311]/10 transition-colors duration-300'>
                    <Image
