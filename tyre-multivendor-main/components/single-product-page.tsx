        ...
        <div className='flex flex-col lg:flex-row gap-8'>
          ...
          <div className='lg:w-1/3'>
            <div className='aspect-square bg-gray-100 rounded-lg overflow-hidden'>
              {(() => {
                const imagePath =
                  productSpec?.productImages?.[0] || productSpec?.serviceImage;
                ...
                <CardContent className='pt-0'>
                  <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4'>
                    ...
                    <div className='flex flex-col sm:flex-row gap-3'>
                      {/* Cart UI - Show counter only when item is in cart */}
                      {isInCart(
                        cheapestProduct._id,
                        ...
                        <div className='flex flex-col gap-2'>
                          ...
                          <div className='flex items-center bg-white border-2 border-[#fca311] rounded-lg p-1'>
                            <Button
                              variant='ghost'
                              size='sm'
                              className='h-8 w-8 p-0 hover:bg-[#fca311]/10 rounded-md cursor-pointer'
                              onClick={() =>
                                updateQuantityByProductVendor(
                                  cheapestProduct._id,
                                  cheapestProduct.vendor._id,
                            ...
                            <Button
                              ...
                              disabled={
                                !cheapestProduct.in_stock ||
                                getCartItemQuantity(
                                  cheapestProduct._id,
                                  cheapestProduct.vendor._id
                                ) >= cheapestProduct.stock_quantity
                              }
                            >
                        ...
                        <Button
                          ...
                          className='bg-[#fca311] hover:bg-[#fca311]/90 text-[#14213d] font-semibold px-6 py-3 text-lg cursor-pointer'
                    ...
                    <div className='space-y-3 text-sm'>
                      ...
                      <div className='bg-gray-50 p-3 rounded-lg'>
                        <div className='flex items-start gap-2 mb-2'>
                          <MapPin className='h-4 w-4 text-[#fca311] mt-0.5 shrink-0' />
                          <div>
                      ...
                      <div className='space-y-2'>
                        {product.vendor.phone && (
                          <div className='flex items-center gap-2 text-gray-600'>
                            <Phone className='h-4 w-4 text-[#fca311]' />
                        ...
                        product.vendor.service_areas.length > 0 && (
                          <div className='bg-[#fca311]/10 p-3 rounded-lg'>
                            <div className='flex items-start gap-2'>
                              <Truck className='h-4 w-4 text-[#fca311] mt-0.5 shrink-0' />
                              <div>
