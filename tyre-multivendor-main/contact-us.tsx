...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-[#e5e5e5]">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#fca311] to-[#e8940f] hover:from-[#e8940f] hover:to-[#d4850e] text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl"
                >
              ...
              <div className="bg-linear-to-br from-[#14213d] to-[#1a2b4a] rounded-2xl p-8 text-white">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-[#fca311] mt-1 flex-shrink-0" />
                    <div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-start gap-2">
                      <MapPin className="w-4 h-4 text-[#fca311] mt-1 flex-shrink-0" />
      ...
      {/* Emergency Contact */}
      <section className="py-16 bg-gradient-to-r from-[#14213d] to-[#1a2b4a] text-white relative overflow-hidden">
