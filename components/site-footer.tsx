...
export default function SiteFooter() {
  ...
  return (
    <footer className='text-white py-12 md:py-16 relative overflow-hidden' style={{ backgroundColor: '#14213d' }}> 
      ...
      <div className='container mx-auto px-4 relative z-10'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-8'>
          {/* Company Info */}
          <div className='md:col-span-2 lg:col-span-1 pl-10 '>
            ...
            <div className='flex items-start gap-3 text-gray-300 text-base mb-6'>
              <MapPin className='h-5 w-5 shrink-0 mt-1 text-brand-orange' />
          ...
          <div>
            ...
            <ul className='space-y-4 text-gray-300'>
              <li className='flex items-start gap-3'>
                <Phone className='h-5 w-5 shrink-0 mt-1 text-brand-orange' />
                <div>
              ...
              <li className='flex items-start gap-3'>
                <Mail className='h-5 w-5 shrink-0 mt-1 text-brand-orange' />
                <div>
                  <div className='font-semibold text-white'>
                    info@autodeal4u.com
                  </div>
        ...
        {/* Bottom Bar */}
        <div className='mt-12 -mx-4 -mb-12 md:-mb-16 px-20 py-8 border-t border-gray-800' style={{ backgroundColor: '#000000' }}>
