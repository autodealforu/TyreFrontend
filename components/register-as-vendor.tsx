...
export default function VendorRegistration() {
  ...
  const onSubmit = async (data: VendorRegistrationForm) => {
    ...
    try {
      ...
      if (vendorRegistrationData?.data) {
        console.log('Vendor registration successful:', vendorRegistrationData.data);
        toast.success(
        ...
        console.error('Vendor registration error:', vendorRegistrationData?.error);
        const error = vendorRegistrationData?.error || 'Something went wrong. Please try again.';
        setErrorMessage(error);
        
        if (error.includes('Kindly contact to our customer service')) {
           router.push(`/registration-error?message=${encodeURIComponent(error)}`);
        } else {
           toast.error(error);
        }
      }
  ...
  // Diagnostic logging for form validation errors
            ...
            <Form {...form}>
              ...
              >
                ...
                <div className='space-y-6'>
                  ...
                  {errorMessage && errorMessage.includes('Kindly contact to our customer service') && (
                  ...
                  <Button
                    type='submit'
                    className='w-full bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white py-3'
