          ...
          <div className='flex items-center gap-2 lg:gap-4'>
            ...
            {isLoading ? (
              ...
              <>
                ...
                <DropdownMenu modal={false}>
                  <DropdownMenuTrigger className='outline-none'>
                    <div className='flex items-center gap-3 px-3 py-2 cursor-pointer rounded-md hover:bg-brand-light-gray transition-colors'>
                      <div className='h-10 w-10 bg-gray-100 border border-gray-200 rounded-full flex items-center justify-center shadow-sm'>
                  ...
                  <DropdownMenuContent
                    align='end'
                    className='w-64 bg-white z-100 shadow-modern border border-gray-200 rounded-xl overflow-hidden'
                  >
              ...
              <>
                ...
                <DropdownMenu modal={false}>
                  <DropdownMenuTrigger className='outline-none'>
                    <div className='h-10 w-10 bg-gray-100 border border-gray-200 rounded-full flex items-center justify-center cursor-pointer'>
                      <User className='h-5 w-5 text-gray-600' />
                    </div>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent align='end' className='w-48 bg-white z-100 shadow-modern border border-gray-200 rounded-xl p-2'>
                    <DropdownMenuItem asChild>
